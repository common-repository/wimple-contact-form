...
# File Name: ajax_form_creation.php													  #
# Purpose: Receive data on ajax request, calculate and return form structure.    	  #
#######################################################################################
...
$wimplecf_horizental_pos 	= sanitize_text_field( $_POST["wimplecf_horizental_pos"] );
$wimplecf_colomn_num 		= filter_var( $_POST["wimplecf_colomn_num"], FILTER_SANITIZE_NUMBER_INT );
...
// to make sure data are set before using them
$wimplecf_rows = isset( $_POST["wimplecf_rows"] ) ? (array) $_POST["wimplecf_rows"] : array();
// Any of the WordPress data sanitization functions can be used here
$wimplecf_rows = array_map( 'sanitize_text_field', $wimplecf_rows );

$wimplecf_first_value		= sanitize_text_field( $_POST["wimplecf_first_value"] );
...
$wimplecf_edit_col_num = $wimplecf_edit_field_id_seperate[1];
	...
	if ( $wimplecf_vertical_pos == 'wimplecf_vertical_at' && $wimplecf_row_num == 'wimplecf_newrow' )
	{
		foreach ( $wimplecf_hidden_values as $wimplecf_hidden_values_esch )
		{
			...
			if ( $wimplecf_each_field[0] != 'wimplecf_newelement' )
			{
				if ( $wimplecf_edit_field_id != '' && 
					 $wimplecf_each_field[7] == $wimplecf_edit_row_num &&
					 $wimplecf_each_field[8] > $wimplecf_edit_col_num )
				{
					$wimplecf_new_col_num = $wimplecf_each_field[8] - 1;
				}
				else
				{
					$wimplecf_new_col_num = $wimplecf_each_field[8];
				}
				
				if ( $wimplecf_edit_field_id != '' && 
					 count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num ) ) == 1 && 
					 $wimplecf_each_field[7] > $wimplecf_edit_row_num )
				{
					$wimplecf_next_row_num_existing = $wimplecf_each_field[7] - 1;
					...
					$wimplecf_form_field .= $wimplecf_each_field[0].'~'
											...
											.$wimplecf_next_row_num_existing.'~'
											.$wimplecf_new_col_num.'~'
				...
				{
					$wimplecf_next_row_num_existing = $wimplecf_each_field[7];
				...
				$wimplecf_row_listing .= '<option value="'.$wimplecf_next_row_num_existing.'">'.wimplecf_ordinal_number_format( $wimplecf_next_row_num_existing ).'</option>,';
			}
			else
			{
				if ( isset( $wimplecf_edit_field_id ) && $wimplecf_edit_field_id != '' && 
				     count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num)) == 1 )
				{
					$wimplecf_next_row_num = $wimplecf_next_row_num - 1;
					
					if ( isset( $wimplecf_first_value ) && $wimplecf_first_value != '' )
					{
						$wimplecf_first_element = $wimplecf_first_value;
					}
					else
					{
						$wimplecf_first_element = 'wimplecf_newelement_temp';
					}
										
					$wimplecf_form_field .= $wimplecf_first_element.'~'
											.$wimplecf_each_field[1].'~'
											.$wimplecf_each_field[2].'~'
											.$wimplecf_each_field[3].'~'
											.$wimplecf_each_field[4].'~'
				...
				$wimplecf_row_listing .= '<option value="'.$wimplecf_next_row_num.'">'.wimplecf_ordinal_number_format( $wimplecf_next_row_num ).'</option>,';
			}
	...
	elseif ( $wimplecf_vertical_pos == 'wimplecf_vertical_before' && $wimplecf_row_num != 'wimplecf_newrow' )
	{
		foreach ( $wimplecf_hidden_values as $wimplecf_hidden_values_esch )
		{
			$wimplecf_each_field = explode( '~',$wimplecf_hidden_values_esch );
			...
			if ( $wimplecf_each_field[0] != 'wimplecf_newelement' &&
			     $wimplecf_each_field[7] < $wimplecf_row_num )
			{
				if ( $wimplecf_edit_field_id != '' && 
					 $wimplecf_each_field[7] == $wimplecf_edit_row_num &&
					 $wimplecf_each_field[8] > $wimplecf_edit_col_num )
				...
				if ( isset( $wimplecf_edit_field_id ) && $wimplecf_edit_field_id != '' &&
				     ...
				     count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num ) ) == 1 )
				{
				   $wimplecf_next_row_num = $wimplecf_each_field[7] - 1;
				...
				{
					$wimplecf_next_row_num = $wimplecf_each_field[7];
			...
			elseif ( $wimplecf_each_field[0] == 'wimplecf_newelement' )
			{
				if ( ( isset( $wimplecf_edit_field_id ) && $wimplecf_edit_field_id != '' ) &&
					 ( isset( $wimplecf_first_value ) && $wimplecf_first_value != '' ) )
				{
					$wimplecf_first_element = $wimplecf_first_value;
				}
				else
				...
				if ( $wimplecf_edit_field_id != '' && 
				     ...
				     $wimplecf_each_field[7] > $wimplecf_edit_row_num )
				{
					$wimplecf_row_num = $wimplecf_row_num - 1;
				...
				$wimplecf_row_listing .= '<option value="'.$wimplecf_row_num.'">'.wimplecf_ordinal_number_format( $wimplecf_row_num ).'</option>,';
			}
			else
			{
				if ( $wimplecf_edit_field_id != '' && 
	...
	elseif ( $wimplecf_vertical_pos == 'wimplecf_vertical_after' && $wimplecf_row_num != 'wimplecf_newrow' )
	{
		foreach ( $wimplecf_hidden_values as $wimplecf_hidden_values_esch )
		{
			$wimplecf_each_field = explode( '~',$wimplecf_hidden_values_esch );
			
			if ( $wimplecf_each_field[0] != 'wimplecf_newelement' && $wimplecf_each_field[7] <= $wimplecf_row_num )
			{
				if ( $wimplecf_edit_field_id != '' && 
				     $wimplecf_each_field[7] > $wimplecf_edit_row_num && 
				     count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num ) ) == 1 )
			...
			elseif ( $wimplecf_each_field[0] == 'wimplecf_newelement' )
			{
				...
				if ( $wimplecf_edit_field_id != '' && 
				     $wimplecf_edit_row_num <= $wimplecf_row_num && 
				     count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num ) ) == 1 )
				{
					$wimplecf_next_row_num = $wimplecf_row_num;
				...
				else
				{
					...
					$wimplecf_next_row_num = $wimplecf_row_num + 1;
	...
	elseif ( $wimplecf_vertical_pos == 'wimplecf_vertical_at' && $wimplecf_row_num != 'wimplecf_newrow' )
	{
		foreach ( $wimplecf_hidden_values as $wimplecf_hidden_values_esch )
		{
			$wimplecf_each_field = explode( '~',$wimplecf_hidden_values_esch );
			...
			if ( ( isset( $wimplecf_edit_field_id ) && $wimplecf_edit_field_id != '' ) )
			{				
				if ( count( array_keys( $wimplecf_rows, $wimplecf_edit_row_num ) ) == 1 )
				{
					if ( $wimplecf_row_num == $wimplecf_edit_row_num ||
					     $wimplecf_each_field[7] < $wimplecf_edit_row_num )
					{
						$wimplecf_next_row_num = $wimplecf_each_field[7];
					}
				...
				if ( ( isset( $wimplecf_first_value ) && $wimplecf_first_value != '' ) && 
							  $wimplecf_each_field[0] == 'wimplecf_newelement' )
				{
					$wimplecf_first_element = $wimplecf_first_value;
				}
				else
				{
					$wimplecf_first_element = $wimplecf_each_field[0];
				}
					
				if ( $wimplecf_row_num == $wimplecf_edit_row_num &&
					 $wimplecf_edit_col_num == $wimplecf_colomn_num )
				{
					$wimplecf_form_field .=	$wimplecf_first_element.'~'
											.$wimplecf_each_field[1].'~'
											.$wimplecf_each_field[2].'~'
				...
				else if ( $wimplecf_horizental_pos == 'wimplecf_horizental_left' )
				{
					if ( $wimplecf_each_field[0] == 'wimplecf_newelement' )
					{
						if ( $wimplecf_row_num == $wimplecf_edit_row_num )
						{
							if ( $wimplecf_edit_col_num < $wimplecf_colomn_num )
							{
								$wimplecf_revised_colomn_num = $wimplecf_colomn_num - 1;
							}
							else
							{
								$wimplecf_revised_colomn_num = $wimplecf_colomn_num;
							}
						}
						else
						{
					...
					else
					{
						if ( ( $wimplecf_row_num != $wimplecf_edit_row_num ) && 
						     ( $wimplecf_each_field[7] == $wimplecf_edit_row_num ) )
					    {
						   if ( $wimplecf_each_field[8] < $wimplecf_edit_col_num )
						   {
							   $wimplecf_revised_colomn_num = $wimplecf_each_field[8];
						   }
						   else
						   {
							   $wimplecf_revised_colomn_num = $wimplecf_each_field[8] - 1;
						   }
					    }
						elseif ( $wimplecf_row_num == $wimplecf_edit_row_num &&
						         $wimplecf_each_field[7] == $wimplecf_row_num )
						{							
							if ( $wimplecf_each_field[8] >= $wimplecf_colomn_num &&
							     $wimplecf_each_field[8] < $wimplecf_edit_col_num )
							{
								$wimplecf_revised_colomn_num = $wimplecf_each_field[8] + 1;
							}
							elseif ( $wimplecf_each_field[8] > $wimplecf_edit_col_num &&
								     $wimplecf_each_field[8] < $wimplecf_colomn_num )
							{
								$wimplecf_revised_colomn_num = $wimplecf_each_field[8] - 1;
							}
							else
						...
						elseif ( $wimplecf_each_field[7] == $wimplecf_row_num )
						{
							if ( $wimplecf_each_field[8] < $wimplecf_colomn_num )
							{
								$wimplecf_revised_colomn_num = $wimplecf_each_field[8];
				...
				elseif ( $wimplecf_horizental_pos == 'wimplecf_horizental_right' )
				{
					if ( $wimplecf_each_field[0] == 'wimplecf_newelement' )
					{						
						if ( $wimplecf_row_num == $wimplecf_edit_row_num )
			...
			{			
				if ( $wimplecf_horizental_pos == 'wimplecf_horizental_left' )
				{
					if ( $wimplecf_each_field[0] == 'wimplecf_newelement' )
					{
						...
						$wimplecf_row_listing .= '<option value="'.$wimplecf_each_field[7].'">'.wimplecf_ordinal_number_format( $wimplecf_each_field[7] ).'</option>,';
					}
					elseif ( $wimplecf_each_field[7] == $wimplecf_row_num &&
					         $wimplecf_each_field[8] >= $wimplecf_colomn_num )
					{
	...
	foreach ( $wimplecf_local_form as $wimplecf_local_form_each )
	{
		...
		if ( isset( $wimplecf_type ) && 
			 $wimplecf_type == 'text' ) 
		{
			$wimplecf_local_html .= '<input type="text" class="form-control wimplecf_validity_check_cls" 
